...
export const SFMA_LOGIC: Record<string, BreakoutChain> = {
  ...
  "Multi-Segmental Extension": {
    ...
    nodes: {
      ...
      "Stabilized FABER Test L": { "FN": { diag: "Left Core (Pelvic Orientation) SMCD.", next: "FABER Test R" }, "DN": { diag: "Left Hip/SI Joint MD.", next: "FABER Test R" }, "any": { diag: "Left hip/SI pain/dysfunction.", next: "FABER Test R" } },
  ...
  "Lower Quarter ER Flow": {
    ...
    nodes: {
      ...
      "Active Seated Tibial ER L": { "FN": { next: "Active Seated Tibial ER R" }, "any": { next: "Passive Prone Tibial ER L" } },
      "Passive Prone Tibial ER L": { "FN": { diag: "Left tibial ER SMCD.", next: "Active Seated Tibial ER R" }, "DN": { diag: "Left tibial ER MD.", next: "Active Seated Tibial ER R" }, "any": { next: "Active Seated Tibial ER R" } },
      "Active Seated Tibial ER R": { "FN": { next: "Lower Quarter IR Flow" }, "any": { next: "Passive Prone Tibial ER R" } },
  ...
  "Lower Quarter IR Flow": {
    ...
    nodes: {
      ...
      "Active Seated Tibial IR L": { "FN": { next: "Active Seated Tibial IR R" }, "any": { next: "Passive Prone Tibial IR L" } },
      "Passive Prone Tibial IR L": { "FN": { diag: "Left tibial IR SMCD.", next: "Active Seated Tibial IR R" }, "DN": { diag: "Left tibial IR MD.", next: "Active Seated Tibial IR R" }, "any": { next: "Active Seated Tibial IR R" } },
      "Active Seated Tibial IR R": { "FN": { next: "EXIT" }, "any": { next: "Passive Prone Tibial IR R" } },
  ...
  "SLS": {
    ...
    nodes: {
      ...
      "Active Tandem Dorsiflexion L": { "FN": { next: "Active Tandem Dorsiflexion R" }, "any": { next: "Passive Prone Dorsiflexion L (Knee Ext)" } },
      "Passive Prone Dorsiflexion L (Knee Ext)": { "FN": { diag: "Left Ankle dorsiflexion SMCD.", next: "Active Tandem Dorsiflexion R" }, "any": { diag: "Left Ankle dorsiflexion MD.", next: "Active Tandem Dorsiflexion R" } },
      "Active Tandem Dorsiflexion R": { "FN": { next: "Active Tandem Plantarflexion L" }, "any": { next: "Passive Prone Dorsiflexion R (Knee Ext)" } },
      ...
      "Active Tandem Plantarflexion L": { "FN": { next: "Active Tandem Plantarflexion R" }, "any": { next: "Passive Plantarflexion L" } },
      "Passive Plantarflexion L": { "FN": { diag: "Left Ankle plantarflexion SMCD.", next: "Active Tandem Plantarflexion R" }, "any": { diag: "Left Ankle plantarflexion MD.", next: "Active Tandem Plantarflexion R" } },
      "Active Tandem Plantarflexion R": { "FN": { next: "Active Seated Ankle Inversion L" }, "any": { next: "Passive Plantarflexion R" } },
      ...
      "Active Seated Ankle Inversion L": { "FN": { next: "Active Seated Ankle Inversion R" }, "any": { next: "Passive Ankle Inversion L" } },
      "Passive Ankle Inversion L": { "FN": { diag: "Left Ankle inversion SMCD.", next: "Active Seated Ankle Inversion R" }, "any": { diag: "Left Ankle inversion MD.", next: "Active Seated Ankle Inversion R" } },
      "Active Seated Ankle Inversion R": { "FN": { next: "Active Seated Ankle Eversion L" }, "any": { next: "Passive Ankle Inversion R" } },
      ...
      "Active Seated Ankle Eversion L": { "FN": { next: "Active Seated Ankle Eversion R" }, "any": { next: "Passive Ankle Eversion L" } },
      "Passive Ankle Eversion L": { "FN": { diag: "Left Ankle eversion SMCD.", next: "Active Seated Ankle Eversion R" }, "any": { diag: "Left Ankle eversion MD.", next: "Active Seated Ankle Eversion R" } },
      "Active Seated Ankle Eversion R": { "FN": { next: "EXIT" }, "any": { next: "Passive Ankle Eversion R" } },
