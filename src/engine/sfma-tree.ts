...
export const SFMA_LOGIC: Record<string, BreakoutChain> = {
  ...
  "Cervical Rotation": {
    start: "Active Supine Cervical Rotation Test",
    nodes: {
      "Active Supine Cervical Rotation Test": { "FN": { diag: "Postural and/or active cervical rotation SMCD.", next: "EXIT" }, "any": { next: "Passive Supine Cervical Rotation Test" } },
      "Passive Supine Cervical Rotation Test": { "FN": { diag: "Active cervical spine rotation SMCD.", next: "EXIT" }, "any": { next: "C1-C2 Cervical Rotation Test (Flexion-Rotation)" } },
      "C1-C2 Cervical Rotation Test (Flexion-Rotation)": { "FN": { diag: "Complex: Mid-lower cervical spine SMCD/MD.", next: "EXIT" }, "DN": { diag: "C1-C2 (Upper Cervical) rotation MD.", next: "EXIT" }, "any": { diag: "C1-C2 (Upper Cervical) rotation pain/dysfunction.", next: "EXIT" } },
    },
  },
  "UE Pattern 1 L": {
  ...
  "Multi-Segmental Flexion": {
    ...
    nodes: {
      ...
      "Active SLR L": { "FN": { next: "Active SLR R" }, "any": { next: "Stabilized ASLR L" } },
      "Stabilized ASLR L": { "FN": { diag: "Left Core (Pelvic) SMCD.", next: "Active SLR R" }, "any": { next: "Passive SLR L" } },
      "Passive SLR L": { "FN": { diag: "Left Hip flexion SMCD.", next: "Active SLR R" }, "any": { next: "Supine Knee to Chest L (Thighs)" } },
      "Supine Knee to Chest L (Thighs)": { "FN": { diag: "Left Posterior chain MD.", next: "Active SLR R" }, "DN": { diag: "Left Hip flexion MD.", next: "Active SLR R" }, "any": { diag: "Left Hip joint pain.", next: "Active SLR R" } },
      "Active SLR R": { "FN": { next: "Prone Rocking" }, "any": { next: "Stabilized ASLR R" } },
  ...
  "Multi-Segmental Extension": {
    ...
    nodes: {
      ...
      "Active Lumbar Locked (IR) Ext/Rot L": { "FN": { next: "Active Lumbar Locked (IR) Ext/Rot R" }, "any": { next: "Passive Lumbar Locked Ext/Rot L" } },
      "Passive Lumbar Locked Ext/Rot L": { "FN": { diag: "Left Thorax ext/rot SMCD.", next: "Active Lumbar Locked (IR) Ext/Rot R" }, "DN": { diag: "Left Thorax ext/rot MD.", next: "Active Lumbar Locked (IR) Ext/Rot R" }, "any": { diag: "Left Thorax pain.", next: "Active Lumbar Locked (IR) Ext/Rot R" } },
      "Active Lumbar Locked (IR) Ext/Rot R": { "FN": { next: "Active Prone on Elbow Ext/Rot L" }, "any": { next: "Passive Lumbar Locked Ext/Rot R" } },
      ...
      "Active Prone on Elbow Ext/Rot L": { "FN": { diag: "Left WB extension SMCD.", next: "Active Prone on Elbow Ext/Rot R" }, "any": { next: "Passive Prone on Elbow Ext/Rot L" } },
      "Passive Prone on Elbow Ext/Rot L": { "FN": { diag: "Left Lumbar ext/rot SMCD.", next: "Active Prone on Elbow Ext/Rot R" }, "DN": { diag: "Left Lumbar ext/rot MD.", next: "Active Prone on Elbow Ext/Rot R" }, "any": { diag: "Left Lumbar pain.", next: "Active Prone on Elbow Ext/Rot R" } },
      "Active Prone on Elbow Ext/Rot R": { "FN": { diag: "Right WB extension SMCD.", next: "Active Prone Shoulder Girdle Flexion L" }, "any": { next: "Passive Prone on Elbow Ext/Rot R" } },
      ...
      "Active Prone Shoulder Girdle Flexion L": { "FN": { next: "Active Prone Shoulder Girdle Flexion R" }, "any": { next: "Passive Prone Shoulder Flexion L" } },
      "Passive Prone Shoulder Flexion L": { "FN": { diag: "Left Shoulder flexion SMCD.", next: "Active Prone Shoulder Girdle Flexion R" }, "any": { diag: "Left Shoulder flexion MD.", next: "Active Prone Shoulder Girdle Flexion R" } },
      "Active Prone Shoulder Girdle Flexion R": { "FN": { next: "FABER Test L" }, "any": { next: "Passive Prone Shoulder Flexion R" } },
      ...
      "FABER Test L": { "FN": { next: "FABER Test R" }, "any": { next: "Stabilized FABER Test L" } },
      "Stabilized FABER Test L": { "FN": { diag: "Left Core (Pelvic Orientation) SMCD.", next: "FABER Test R" }, "any": { next: "Passive FABER Test L" } },
      "Passive FABER Test L": { "FN": { diag: "Left hip SMCD.", next: "FABER Test R" }, "DN": { diag: "Left Hip/SI Joint MD.", next: "FABER Test R" }, "any": { diag: "Left hip/SI pain/dysfunction.", next: "FABER Test R" } },
      "FABER Test R": { "FN": { next: "Modified Thomas Test L" }, "any": { next: "Stabilized FABER Test R" } },
      "Stabilized FABER Test R": { "FN": { diag: "Right Core (Pelvic Orientation) SMCD.", next: "Modified Thomas Test L" }, "any": { next: "Passive FABER Test R" } },
      "Passive FABER Test R": { "FN": { diag: "Right hip SMCD.", next: "Modified Thomas Test L" }, "DN": { diag: "Right Hip/SI Joint MD.", next: "Modified Thomas Test L" }, "any": { diag: "Right hip/SI pain/dysfunction.", next: "Modified Thomas Test L" } },
      ...
      "Active Prone Hip Extension L": { "FN": { next: "Active Prone Hip Extension R" }, "any": { next: "Passive Prone Hip Extension L" } },
      "Passive Prone Hip Extension L": { "FN": { diag: "Left hip extension SMCD.", next: "Active Prone Hip Extension R" }, "DN": { diag: "Left hip extension MD.", next: "Active Prone Hip Extension R" }, "any": { diag: "Left hip extension pain.", next: "Active Prone Hip Extension R" } },
      "Active Prone Hip Extension R": { "FN": { diag: "Bilateral Extension Normal.", next: "EXIT" }, "any": { next: "Passive Prone Hip Extension R" } },
  ...
  "Lower Quarter ER Flow": {
    ...
    nodes: {
      "Active Prone Hip ER L": { "FN": { next: "Active Prone Hip ER R" }, "any": { next: "Stabilized Prone External Hip Rotation L" } },
      "Stabilized Prone External Hip Rotation L": { "FN": { diag: "Left Core (Pelvic Orientation) SMCD.", next: "Active Prone Hip ER R" }, "any": { next: "Passive Prone Hip ER L" } },
      "Passive Prone Hip ER L": { "FN": { diag: "Left WB/active hip ER SMCD.", next: "Active Prone Hip ER R" }, "DN": { diag: "Left hip ER MD.", next: "Active Prone Hip ER R" }, "any": { diag: "Left hip ER pain/dysfunction.", next: "Active Prone Hip ER R" } },
      "Active Prone Hip ER R": { "FN": { next: "Active Seated Tibial ER L" }, "any": { next: "Stabilized Prone External Hip Rotation R" } },
      ...
      "Active Seated Tibial ER L": { "FN": { next: "Active Seated Tibial ER R" }, "any": { next: "Passive Seated Tibial ER L" } },
      "Passive Seated Tibial ER L": { "FN": { diag: "Left tibial ER SMCD.", next: "Active Seated Tibial ER R" }, "DN": { diag: "Left tibial ER MD.", next: "Active Seated Tibial ER R" }, "any": { next: "Active Seated Tibial ER R" } },
      "Active Seated Tibial ER R": { "FN": { next: "Lower Quarter IR Flow" }, "any": { next: "Passive Seated Tibial ER R" } },
      "Passive Seated Tibial ER R": { "FN": { diag: "Right tibial ER SMCD.", next: "Lower Quarter IR Flow" }, "DN": { diag: "Right tibial ER MD.", next: "Lower Quarter IR Flow" }, "any": { diag: "Right tibial ER pain/dysfunction.", next: "Lower Quarter IR Flow" } },
    },
  },
  "Lower Quarter IR Flow": {
    start: "Active Prone Hip IR L",
    nodes: {
      "Active Prone Hip IR L": { "FN": { next: "Active Prone Hip IR R" }, "any": { next: "Stabilized Prone Internal Hip Rotation L" } },
      "Stabilized Prone Internal Hip Rotation L": { "FN": { diag: "Left Core (Pelvic Orientation) SMCD.", next: "Active Prone Hip IR R" }, "any": { next: "Passive Prone Hip IR L" } },
      "Passive Prone Hip IR L": { "FN": { diag: "Left WB/active hip IR SMCD.", next: "Active Prone Hip IR R" }, "DN": { diag: "Left hip IR MD.", next: "Active Prone Hip IR R" }, "any": { diag: "Left hip IR pain/dysfunction.", next: "Active Prone Hip IR R" } },
      "Active Prone Hip IR R": { "FN": { next: "Active Seated Tibial IR L" }, "any": { next: "Stabilized Prone Internal Hip Rotation R" } },
      ...
      "Active Seated Tibial IR L": { "FN": { next: "Active Seated Tibial IR R" }, "any": { next: "Passive Seated Tibial IR L" } },
      "Passive Seated Tibial IR L": { "FN": { diag: "Left tibial IR SMCD.", next: "Active Seated Tibial IR R" }, "DN": { diag: "Left tibial IR MD.", next: "Active Seated Tibial IR R" }, "any": { next: "Active Seated Tibial IR R" } },
      "Active Seated Tibial IR R": { "FN": { next: "EXIT" }, "any": { next: "Passive Seated Tibial IR R" } },
      "Passive Seated Tibial IR R": { "FN": { diag: "Right tibial IR SMCD.", next: "EXIT" }, "DN": { diag: "Right tibial IR MD.", next: "EXIT" }, "any": { diag: "Right tibial IR pain/dysfunction.", next: "EXIT" } },
    },
  },
  "SLS": {
    ...
    nodes: {
      ...
      "Active Tandem Dorsiflexion R": { "FN": { next: "Active Tandem Plantarflexion L" }, "any": { next: "Active Tandem Plantarflexion L" } },
      "Active Tandem Plantarflexion L": { "FN": { next: "Active Tandem Plantarflexion R" }, "any": { next: "Active Tandem Plantarflexion R" } },
      "Active Tandem Plantarflexion R": { "FN": { next: "CHECK_Active Tandem Dorsiflexion L|Passive Dorsiflexion L (Knee Ext)|CHECK_Active Tandem Dorsiflexion R|Passive Dorsiflexion R (Knee Ext)|CHECK_Active Tandem Plantarflexion L|Passive Plantarflexion L|CHECK_Active Tandem Plantarflexion R|Passive Plantarflexion R|Active Seated Ankle Inversion L" }, "any": { next: "CHECK_Active Tandem Dorsiflexion L|Passive Dorsiflexion L (Knee Ext)|CHECK_Active Tandem Dorsiflexion R|Passive Dorsiflexion R (Knee Ext)|CHECK_Active Tandem Plantarflexion L|Passive Plantarflexion L|CHECK_Active Tandem Plantarflexion R|Passive Plantarflexion R|Active Seated Ankle Inversion L" } },
      "Passive Dorsiflexion L (Knee Ext)": { "FN": { diag: "Left Ankle dorsiflexion SMCD.", next: "CHECK_Active Tandem Dorsiflexion R|Passive Dorsiflexion R (Knee Ext)|CHECK_Active Tandem Plantarflexion L|Passive Plantarflexion L|CHECK_Active Tandem Plantarflexion R|Passive Plantarflexion R|Active Seated Ankle Inversion L" }, "any": { diag: "Left Ankle dorsiflexion MD.", next: "CHECK_Active Tandem Dorsiflexion R|Passive Dorsiflexion R (Knee Ext)|CHECK_Active Tandem Plantarflexion L|Passive Plantarflexion L|CHECK_Active Tandem Plantarflexion R|Passive Plantarflexion R|Active Seated Ankle Inversion L" } },
      "Passive Dorsiflexion R (Knee Ext)": { "FN": { diag: "Right Ankle dorsiflexion SMCD.", next: "CHECK_Active Tandem Plantarflexion L|Passive Plantarflexion L|CHECK_Active Tandem Plantarflexion R|Passive Plantarflexion R|Active Seated Ankle Inversion L" }, "any": { diag: "Right Ankle dorsiflexion MD.", next: "CHECK_Active Tandem Plantarflexion L|Passive Plantarflexion L|CHECK_Active Tandem Plantarflexion R|Passive Plantarflexion R|Active Seated Ankle Inversion L" } },
      ...
      "Active Seated Ankle Inversion R": { "FN": { next: "Active Seated Ankle Eversion L" }, "any": { next: "Active Seated Ankle Eversion L" } },
      "Active Seated Ankle Eversion L": { "FN": { next: "Active Seated Ankle Eversion R" }, "any": { next: "Active Seated Ankle Eversion R" } },
      "Active Seated Ankle Eversion R": { "FN": { next: "CHECK_Active Seated Ankle Inversion L|Passive Ankle Inversion L|CHECK_Active Seated Ankle Inversion R|Passive Ankle Inversion R|CHECK_Active Seated Ankle Eversion L|Passive Ankle Eversion L|CHECK_Active Seated Ankle Eversion R|Passive Ankle Eversion R|EXIT" }, "any": { next: "CHECK_Active Seated Ankle Inversion L|Passive Ankle Inversion L|CHECK_Active Seated Ankle Inversion R|Passive Ankle Inversion R|CHECK_Active Seated Ankle Eversion L|Passive Ankle Eversion L|CHECK_Active Seated Ankle Eversion R|Passive Ankle Eversion R|EXIT" } },
      "Passive Ankle Inversion L": { "FN": { diag: "Left Ankle inversion SMCD.", next: "CHECK_Active Seated Ankle Inversion R|Passive Ankle Inversion R|CHECK_Active Seated Ankle Eversion L|Passive Ankle Eversion L|CHECK_Active Seated Ankle Eversion R|Passive Ankle Eversion R|EXIT" }, "any": { diag: "Left Ankle inversion MD.", next: "CHECK_Active Seated Ankle Inversion R|Passive Ankle Inversion R|CHECK_Active Seated Ankle Eversion L|Passive Ankle Eversion L|CHECK_Active Seated Ankle Eversion R|Passive Ankle Eversion R|EXIT" } },
      "Passive Ankle Inversion R": { "FN": { diag: "Right Ankle inversion SMCD.", next: "CHECK_Active Seated Ankle Eversion L|Passive Ankle Eversion L|CHECK_Active Seated Ankle Eversion R|Passive Ankle Eversion R|EXIT" }, "any": { diag: "Right Ankle inversion MD.", next: "CHECK_Active Seated Ankle Eversion L|Passive Ankle Eversion L|CHECK_Active Seated Ankle Eversion R|Passive Ankle Eversion R|EXIT" } },
  ...
  "Deep Squat": {
    ...
    nodes: {
      "Active Tandem Dorsiflexion - Knee Flexed L": { "FN": { next: "Active Tandem Dorsiflexion - Knee Flexed R" }, "any": { next: "Passive Prone Dorsiflexion - Knee Flexed L" } },
      "Passive Prone Dorsiflexion - Knee Flexed L": { "FN": { diag: "Left ankle dorsiflexion SMCD (knee flexed).", next: "Active Tandem Dorsiflexion - Knee Flexed R" }, "DN": { diag: "Left ankle dorsiflexion MD (knee flexed).", next: "Active Tandem Dorsiflexion - Knee Flexed R" }, "any": { diag: "Left ankle dorsiflexion pain/dysfunction.", next: "Active Tandem Dorsiflexion - Knee Flexed R" } },
      "Active Tandem Dorsiflexion - Knee Flexed R": { "FN": { next: "Active Seated Ankle Inversion/Eversion L" }, "any": { next: "Passive Prone Dorsiflexion - Knee Flexed R" } },
      ...
      "Active Seated Ankle Inversion/Eversion L": { "FN": { next: "Active Seated Ankle Inversion/Eversion R" }, "any": { next: "Passive Ankle Inversion/Eversion L" } },
      "Passive Ankle Inversion/Eversion L": { "FN": { diag: "Left ankle inversion/eversion SMCD.", next: "Active Seated Ankle Inversion/Eversion R" }, "DN": { diag: "Left ankle inversion/eversion MD.", next: "Active Seated Ankle Inversion/Eversion R" }, "any": { next: "Active Seated Ankle Inversion/Eversion R" } },
      "Active Seated Ankle Inversion/Eversion R": { "FN": { next: "Supine Knees to Chest (Shins)" }, "any": { next: "Passive Ankle Inversion/Eversion R" } },
      ...
      "Active Seated Hip IR L": { "FN": { next: "Active Seated Hip IR R" }, "any": { next: "Passive Seated Hip IR L" } },
      "Passive Seated Hip IR L": { "FN": { diag: "Left hip IR SMCD.", next: "Active Seated Hip IR R" }, "DN": { diag: "Left hip IR MD.", next: "Active Seated Hip IR R" }, "any": { next: "Active Seated Hip IR R" } },
      "Active Seated Hip IR R": { "FN": { next: "Active Seated Hip ER L" }, "any": { next: "Passive Seated Hip IR R" } },
      ...
      "Active Seated Hip ER L": { "FN": { next: "Active Seated Hip ER R" }, "any": { next: "Passive Seated Hip ER L" } },
      "Passive Seated Hip ER L": { "FN": { diag: "Left hip ER SMCD.", next: "Active Seated Hip ER R" }, "DN": { diag: "Left hip ER MD.", next: "Active Seated Hip ER R" }, "any": { next: "Active Seated Hip ER R" } },
      "Active Seated Hip ER R": { "FN": { diag: "Squat Isolation Clear.", next: "EXIT" }, "any": { next: "Passive Seated Hip ER R" } },
