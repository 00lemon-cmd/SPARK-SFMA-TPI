...
export const L1_SCREENS: L1Screen[] = [
  {
    ...
    category: "Lower Body",
    linkedFaults: ["early_extension", "loss_of_posture", "sway", "slide", "hanging_back", "s_posture", "steep_swing_plane", "hiking"],
  },
  {
    id: "single_leg_balance",
    name: "Single Leg Balance",
    category: "Balance",
    linkedFaults: ["sway", "slide", "hanging_back", "reverse_pivot", "straightening_trail_leg", "hiking"],
  },
  {
    id: "toe_touch",
    name: "Toe Touch",
    category: "Flexion",
    linkedFaults: ["loss_of_posture", "early_extension", "s_posture", "reverse_spine_angle", "hiking"],
  },
  {
    id: "pelvic_tilt",
    name: "Pelvic Tilt Test",
    category: "Core",
    linkedFaults: ["s_posture", "early_extension", "loss_of_posture", "reverse_spine_angle", "right_hip_high", "hiking"],
  },
  {
    id: "pelvic_rotation",
    name: "Pelvic Rotation Test",
    category: "Core",
    linkedFaults: ["sway", "slide", "early_extension", "reverse_spine_angle", "hanging_back", "hiking"],
  },
  {
    id: "torso_rotation",
    name: "Torso Rotation Test",
    category: "Rotation",
    linkedFaults: ["reverse_spine_angle", "over_the_top", "casting", "flat_shoulder_plane", "excessive_spinal_rotation", "limited_follow_through", "steep_swing_plane"],
  },
  {
  ...
  },
  {
    ...
    linkedFaults: ["early_extension", "sway", "slide", "loss_of_posture", "reverse_spine_angle", "straightening_trail_leg", "square_feet_stance", "hiking"],
  },
  {
    id: "lat_length",
  ...
  },
  {
    ...
    category: "Upper Extremity",
    linkedFaults: ["rolling_wrists", "casting", "scooping", "fat_divots"],
  },
  {
